...
=item * epublica GmbH (<http://www.epublica.de/>)

=item * XING AG (<https://www.xing.com/>) for making this work possible and running PerlIDS under heavy load for a long time.
